 ...
 * @var iterable<\App\Model\Entity\SalesInvoice> $salesInvoices
 * @var array $kpis
 */
$this->assign('title', 'Sales Invoices');
?>
...
<div class="page-header">
    ...
    <p>Manage product sales invoices and payments</p>
</div>
...
<div class="kpi-grid">
    ...
    <div class="kpi-card draft">
        <i class="fas fa-file kpi-icon"></i>
        <div class="kpi-label">Draft</div>
        <div class="kpi-value"><?= number_format($kpis['draft']) ?></div>
    </div>
    ...
    <div class="kpi-card value">
        ...
        <div class="kpi-value"><?= $this->Number->currency($kpis['total_value_sum'], 'NGN') ?></div>
    </div>
</div>
...
<div class="invoice-table">
    <?php if (!empty($salesInvoices) && count($salesInvoices) > 0): ?>
    <table id="invoiceTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $this->Number->format($invoice->quantity, ['places' => 2]) ?></td>
                <td><strong><?= $this->Number->currency($invoice->total_value, $invoice->currency) ?></strong></td>
                <td>
    ...
    <div class="no-data">
        ...
        <p>Get started by creating your first sales invoice</p>
        <?= $this->Html->link(
            '<i class="fas fa-plus"></i> Create Sales Invoice',
            ['action' => 'add'],
