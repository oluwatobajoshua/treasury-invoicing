...
<div class="page-header-sleek">
  ...
  <p class="page-subtitle-sleek" style="margin: .25rem 0 0; opacity: .9">Create a new client record</p>
 </div>
...
<div class="form-card">
  ...
  <div class="form-card-body">
    ...
    <div class="btn-group-sleek">
      <?= $this->Form->button('<i class="fas fa-check"></i> Save Client', ['class' => 'btn btn-primary','escapeTitle' => false]) ?>
