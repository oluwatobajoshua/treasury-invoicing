...
$this->assign('title', 'Edit SGC Account');
?>
<style>
...
<div class="page-header-sleek">
  <div style="display:flex;justify-content:space-between;align-items:center">
    <h1><i class="fas fa-wallet"></i> Edit SGC Account</h1>
    <div class="btn-group-sleek">
      <?= $this->Html->link('<i class="fas fa-arrow-left"></i> Back', ['action' => 'index'], ['class' => 'btn btn-light','escape' => false]) ?>
      <?= $this->Html->link('<i class="fas fa-eye"></i> View', ['action' => 'view', $sgcAccount->id], ['class' => 'btn btn-primary','escape' => false]) ?>
    </div>
  </div>
</div>
