...
<div class="page-header-sleek">
  <div>
    <h1 class="page-title-sleek"><i class="fas fa-landmark"></i> Add Bank</h1>
    <p class="page-subtitle-sleek">Create a new bank record</p>
  </div>
  <div>
...
<div class="data-card-sleek">
  ...
  <div class="card-body-sleek">
    <?= $this->Form->create($bank) ?>
      <div class="row g-3">
        <div class="col-md-6">
          <?= $this->Form->control('bank_name', ['label'=>'Bank Name','class'=>'form-control', 'required'=>true]) ?>
        </div>
        <div class="col-md-3">
      ...
      <div class="mt-3">
        <?= $this->Form->button('<i class="fas fa-save"></i> Save Bank', ['class'=>'btn btn-success', 'escapeTitle'=>false]) ?>
      </div>
    <?= $this->Form->end() ?>
  </div>
</div>
