<?php
$this->assign('title', 'Add Allowance Rate');
?>
...
<div class="form-card fade-in">
	<h2 style="margin:0 0 .9rem;font-size:1rem;display:flex;align-items:center;gap:.4rem;">💸 Add Allowance Rate</h2>
	...
	<div class="form-row">
		...
		<?= $this->Form->control('currency', ['type' => 'select', 'options' => ['NGN' => 'NGN', 'USD' => 'USD'], 'empty' => 'Select currency', 'value' => 'NGN', 'label' => 'Currency']) ?>
	</div>
	<div class="form-row">
