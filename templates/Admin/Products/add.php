...
<div class="page-header-sleek">
  ...
  <p style="margin:.25rem 0 0;opacity:.9">Create a new product</p>
</div>
...
<div class="form-card">
  ...
  <div class="form-card-body">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-6">
        <?= $this->Form->control('category', [
          ...
          'class' => 'form-control','placeholder' => 'e.g., Cocoa'
        ]) ?>
      </div>
    </div>
    <div class="row mb-3">
    ...
    <div class="btn-group-sleek">
      <?= $this->Form->button('<i class="fas fa-check"></i> Save Product', ['class' => 'btn btn-primary','escapeTitle' => false]) ?>
