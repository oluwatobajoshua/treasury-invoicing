...
<div class="page-header-sleek">
    <div>
        ...
        <p class="page-subtitle-sleek">Manage product catalog and pricing</p>
    </div>
    <div>
        <?= $this->Html->link(
...
<div class="stats-row-sleek">
    <div class="stat-card-sleek">
        ...
        <div class="stat-label-sleek">Total Products</div>
        <div class="stat-value-sleek"><?= count($products) ?></div>
    </div>
    ...
    <div class="stat-card-sleek" style="border-left-color: var(--sunbeth-orange);">
        ...
        <div class="stat-label-sleek">Avg. Price</div>
        <div class="stat-value-sleek">
            <?php 
            $total = 0;
            $count = 0;
...
<div class="data-card-sleek">
    <div class="card-toolbar-sleek">
        ...
        <div class="toolbar-actions-sleek">
            <button class="btn-sleek btn-outline-sleek" onclick="$('#productsTable').DataTable().button('.buttons-excel').trigger();">
                <i class="fas fa-file-excel"></i> Excel
            </button>
            <button class="btn-sleek btn-outline-sleek" onclick="$('#productsTable').DataTable().button('.buttons-pdf').trigger();">
        ...
        <table id="productsTable" class="table table-hover" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="product-name-sleek"><?= h($product->name) ?></div>
                    </td>
                    <td>
                        <span class="product-code-sleek"><?= h($product->product_code) ?></span>
                    </td>
                    ...
                    <td>
                        <?php if ($product->unit_price): ?>
                            <span class="price-sleek">$<?= number_format($product->unit_price, 2) ?></span>
                        <?php else: ?>
