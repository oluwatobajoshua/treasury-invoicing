 ...
 */
$this->assign('title', 'Edit Contract - ' . $contract->contract_id);
?>
...
<div class="form-card">
    <div class="form-card-header">
        <h2><i class="fas fa-file-contract"></i> Contract Information</h2>
    </div>
    <div class="form-card-body">
        ...
        <div class="btn-group-sleek">
            <?= $this->Form->button('<i class="fas fa-check"></i> Update Contract', [
